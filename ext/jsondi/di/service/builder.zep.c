 ...
 */
/**
 * JsonDi\Di\Service\Builder
 *
 * This class builds instances based on complex definitions
 */
ZEPHIR_INIT_CLASS(JsonDi_Di_Service_Builder) {

	ZEPHIR_REGISTER_CLASS(JsonDi\\Di\\Service, Builder, jsondi, di_service_builder, jsondi_di_service_builder_method_entry, 0);
 ...
 * @return mixed
 */
PHP_METHOD(JsonDi_Di_Service_Builder, build) {
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&className, &definition, SL("className"), 0)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "Invalid service definition. Missing 'className' parameter", "jsondi/Di/Service/Builder.zep", 41);
		return;
	}
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("calls"), 0)) {
		if (UNEXPECTED(Z_TYPE_P(&instance) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "The definition has setter injection parameters but the constructor didn't return an instance", "jsondi/Di/Service/Builder.zep", 83);
			return;
		}
		if (UNEXPECTED(Z_TYPE_P(&paramCalls) != IS_ARRAY)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "Setter injection parameters must be an array", "jsondi/Di/Service/Builder.zep", 89);
			return;
		}
		zephir_is_iterable(&paramCalls, 0, "jsondi/Di/Service/Builder.zep", 148);
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _4$$10, _5$$10, _2$$10)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&method) != IS_ARRAY)) {
					...
					object_init_ex(&_6$$14, jsondi_di_exception_ce);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_6$$14, "jsondi/Di/Service/Builder.zep", 103);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (UNEXPECTED(!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0)))) {
					...
					object_init_ex(&_9$$15, jsondi_di_exception_ce);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_9$$15, "jsondi/Di/Service/Builder.zep", 112);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
					if (UNEXPECTED(Z_TYPE_P(&arguments) != IS_ARRAY)) {
						...
						object_init_ex(&_11$$17, jsondi_di_exception_ce);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_11$$17, "jsondi/Di/Service/Builder.zep", 124);
						ZEPHIR_MM_RESTORE();
						return;
					}
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&method) != IS_ARRAY)) {
						...
						object_init_ex(&_16$$20, jsondi_di_exception_ce);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_16$$20, "jsondi/Di/Service/Builder.zep", 103);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&methodName);
					if (UNEXPECTED(!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0)))) {
						...
						object_init_ex(&_18$$21, jsondi_di_exception_ce);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_18$$21, "jsondi/Di/Service/Builder.zep", 112);
						ZEPHIR_MM_RESTORE();
						return;
					}
					...
					if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
						if (UNEXPECTED(Z_TYPE_P(&arguments) != IS_ARRAY)) {
							...
							object_init_ex(&_21$$23, jsondi_di_exception_ce);
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_21$$23, "jsondi/Di/Service/Builder.zep", 124);
							ZEPHIR_MM_RESTORE();
							return;
						}
						if (zephir_fast_count_int(&arguments)) {
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("properties"), 0)) {
		if (UNEXPECTED(Z_TYPE_P(&instance) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "The definition has properties injection parameters but the constructor didn't return an instance", "jsondi/Di/Service/Builder.zep", 158);
			return;
		}
		if (UNEXPECTED(Z_TYPE_P(&paramCalls) != IS_ARRAY)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "Setter injection parameters must be an array", "jsondi/Di/Service/Builder.zep", 164);
			return;
		}
		zephir_is_iterable(&paramCalls, 0, "jsondi/Di/Service/Builder.zep", 208);
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _28$$25, _29$$25, _26$$25)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&property) != IS_ARRAY)) {
					...
					object_init_ex(&_30$$29, jsondi_di_exception_ce);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_30$$29, "jsondi/Di/Service/Builder.zep", 178);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0)))) {
					...
					object_init_ex(&_32$$30, jsondi_di_exception_ce);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_32$$30, "jsondi/Di/Service/Builder.zep", 187);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0)))) {
					...
					object_init_ex(&_34$$31, jsondi_di_exception_ce);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_34$$31, "jsondi/Di/Service/Builder.zep", 196);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&property) != IS_ARRAY)) {
						...
						object_init_ex(&_38$$33, jsondi_di_exception_ce);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_38$$33, "jsondi/Di/Service/Builder.zep", 178);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&propertyName);
					if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0)))) {
						...
						object_init_ex(&_40$$34, jsondi_di_exception_ce);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_40$$34, "jsondi/Di/Service/Builder.zep", 187);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&propertyValue);
					if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0)))) {
						...
						object_init_ex(&_42$$35, jsondi_di_exception_ce);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_42$$35, "jsondi/Di/Service/Builder.zep", 196);
						ZEPHIR_MM_RESTORE();
						return;
					}
 ...
 * @return mixed
 */
PHP_METHOD(JsonDi_Di_Service_Builder, buildParameter) {
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&type, &argument, SL("type"), 0)))) {
		...
		object_init_ex(&_0$$3, jsondi_di_exception_ce);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "jsondi/Di/Service/Builder.zep", 228);
		ZEPHIR_MM_RESTORE();
		return;
	}
	do {
		if (ZEPHIR_IS_STRING(&type, "service")) {
			...
			if (UNEXPECTED(!(zephir_array_isset_string_fetch(&name, &argument, SL("name"), 0)))) {
				...
				object_init_ex(&_3$$5, jsondi_di_exception_ce);
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_3$$5, "jsondi/Di/Service/Builder.zep", 241);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (UNEXPECTED(Z_TYPE_P(container) != IS_OBJECT)) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "The dependency injector container is not valid", "jsondi/Di/Service/Builder.zep", 247);
				return;
			}
		...
		if (ZEPHIR_IS_STRING(&type, "parameter")) {
			...
			if (UNEXPECTED(!(zephir_array_isset_string_fetch(&value, &argument, SL("value"), 0)))) {
				...
				object_init_ex(&_6$$8, jsondi_di_exception_ce);
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$8, "jsondi/Di/Service/Builder.zep", 259);
				ZEPHIR_MM_RESTORE();
				return;
			}
			RETURN_CCTOR(&value);
		...
		if (ZEPHIR_IS_STRING(&type, "instance")) {
			...
			if (UNEXPECTED(!(zephir_array_isset_string_fetch(&name, &argument, SL("className"), 0)))) {
				...
				object_init_ex(&_9$$10, jsondi_di_exception_ce);
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_9$$10, "jsondi/Di/Service/Builder.zep", 272);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (UNEXPECTED(Z_TYPE_P(container) != IS_OBJECT)) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(jsondi_di_exception_ce, "The dependency injector container is not valid", "jsondi/Di/Service/Builder.zep", 278);
				return;
			}
		...
		object_init_ex(&_12$$13, jsondi_di_exception_ce);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_12$$13, "jsondi/Di/Service/Builder.zep", 300);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
 ...
 */
PHP_METHOD(JsonDi_Di_Service_Builder, buildParameters) {
	...
	zephir_is_iterable(&arguments, 0, "jsondi/Di/Service/Builder.zep", 322);
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&arguments), _2, _3, _0)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&buildArguments, &_4$$3, PH_SEPARATE, "jsondi/Di/Service/Builder.zep", 319);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&buildArguments, &_6$$4, PH_SEPARATE, "jsondi/Di/Service/Builder.zep", 319);
