...
ZEPHIR_INIT_CLASS(JsonDi_Config_Adapter_Php) {
	...
	ZEPHIR_REGISTER_CLASS_EX(JsonDi\\Config\\Adapter, Php, jsondi, config_adapter_php, jsondi_config_ce, jsondi_config_adapter_php_method_entry, 0);
...
/**
 * JsonDi\Config\Adapter\Php constructor
 */
PHP_METHOD(JsonDi_Config_Adapter_Php, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, jsondi_config_adapter_php_ce, getThis(), "__construct", &_0, 0, &_1);
