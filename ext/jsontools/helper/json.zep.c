...
/**
 * This file is part of the JsonTools.
 *
 * (c) JsonTools Team <team@datas.com>
 *
...
ZEPHIR_INIT_CLASS(JsonTools_Helper_Json) {
	...
	ZEPHIR_REGISTER_CLASS(JsonTools\\Helper, Json, jsontools, helper_json, jsontools_helper_json_method_entry, 0);
...
PHP_METHOD(JsonTools_Helper_Json, decode) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "json_last_error", NULL, 22);
	zephir_check_call_status();
	if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_3, 0))) {
		ZEPHIR_INIT_VAR(&_4$$3);
		object_init_ex(&_4$$3, spl_ce_InvalidArgumentException);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "json_last_error_msg", NULL, 23);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_6$$3);
		ZEPHIR_CONCAT_SV(&_6$$3, "json_decode error: ", &_5$$3);
		ZEPHIR_CALL_METHOD(NULL, &_4$$3, "__construct", NULL, 24, &_6$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$3, "jsontools/Helper/Json.zep", 60);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(JsonTools_Helper_Json, encode) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_2, 0))) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "json_last_error_msg", NULL, 23);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_5$$3);
		ZEPHIR_CONCAT_SV(&_5$$3, "json_encode error: ", &_4$$3);
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 24, &_5$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "jsontools/Helper/Json.zep", 104);
		ZEPHIR_MM_RESTORE();
		return;
	}
