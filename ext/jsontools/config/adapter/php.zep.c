...
ZEPHIR_INIT_CLASS(JsonTools_Config_Adapter_Php) {
	...
	ZEPHIR_REGISTER_CLASS_EX(JsonTools\\Config\\Adapter, Php, jsontools, config_adapter_php, jsontools_config_ce, jsontools_config_adapter_php_method_entry, 0);
...
/**
 * JsonTools\Config\Adapter\Php constructor
 */
PHP_METHOD(JsonTools_Config_Adapter_Php, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, jsontools_config_adapter_php_ce, getThis(), "__construct", &_0, 0, &_1);
